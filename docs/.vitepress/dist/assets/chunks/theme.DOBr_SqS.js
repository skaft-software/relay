...
void main() {
	...
	`}class Ru extends yn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Eu(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Tr(5,5,5),s=new Cn({name:"CubemapFromEquirect",uniforms:tr(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Zt,blending:On});s.uniforms.tEquirect.value=t;const a=new Ut(r,s),o=t.minFilter;return t.minFilter===mi&&(t.minFilter=Gt),new yx(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,r);e.setRenderTarget(s)}}function Sv(n){let e=new WeakMap,t=new WeakMap,i=null;function r(u,p=!1){return u==null?null:p?a(u):s(u)}function s(u){if(u&&u.isTexture){const p=u.mapping;if(p===Ws||p===$s)if(e.has(u)){const x=e.get(u).texture;return o(x,u.mapping)}else{const x=u.image;if(x&&x.height>0){const S=new Ru(x.height);return S.fromEquirectangularTexture(n,u),e.set(u,S),u.addEventListener("dispose",l),o(S.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const p=u.mapping,x=p===Ws||p===$s,S=p===Si||p===Ji;if(x||S){let m=t.get(u);const h=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==h)return i===null&&(i=new nc(n)),m=x?i.fromEquirectangular(u,m):i.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const E=u.image;return x&&E&&E.height>0||S&&E&&c(E)?(i===null&&(i=new nc(n)),m=x?i.fromEquirectangular(u):i.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",d),m.texture):null}}}return u}function o(u,p){return p===Ws?u.mapping=Si:p===$s&&(u.mapping=Ji),u}function c(u){let p=0;const x=6;for(let S=0;S<x;S++)u[S]!==void 0&&p++;return p===x}function l(u){const p=u.target;p.removeEventListener("dispose",l);const x=e.get(p);x!==void 0&&(e.delete(p),x.dispose())}function d(u){const p=u.target;p.removeEventListener("dispose",d);const x=t.get(p);x!==void 0&&(t.delete(p),x.dispose())}function f(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function Mv(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&So("WebGLRenderer: "+i+" extension not supported."),r}}}function Ev(n,e,t,i){const r={},s=new WeakMap;function a(f){const u=f.target;u.index!==null&&e.remove(u.index);for(const x in u.attributes)e.remove(u.attributes[x]);u.removeEventListener("dispose",a),delete r[u.id];const p=s.get(u);p&&(e.remove(p),s.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(f,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function c(f){const u=f.attributes;for(const p in u)e.update(u[p],n.ARRAY_BUFFER)}function l(f){const u=[],p=f.index,x=f.attributes.position;let S=0;if(x===void 0)return;if(p!==null){const E=p.array;S=p.version;for(let A=0,T=E.length;A<T;A+=3){const L=E[A+0],M=E[A+1],w=E[A+2];u.push(L,M,M,w,w,L)}}else{const E=x.array;S=x.version;for(let A=0,T=E.length/3-1;A<T;A+=3){const L=A+0,M=A+1,w=A+2;u.push(L,M,M,w,w,L)}}const m=new(x.count>=65535?_u:gu)(u,1);m.version=S;const h=s.get(f);h&&e.remove(h),s.set(f,m)}function d(f){const u=s.get(f);if(u){const p=f.index;p!==null&&u.version<p.version&&l(f)}else l(f);return s.get(f)}return{get:o,update:c,getWireframeAttribute:d}}function bv(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,u){n.drawElements(i,u,s,f*a),t.update(u,i,1)}function l(f,u,p){p!==0&&(n.drawElementsInstanced(i,u,s,f*a,p),t.update(u,i,p))}function d(f,u,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,u,0,s,f,0,p);let S=0;for(let m=0;m<p;m++)S+=u[m];t.update(S,i,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d}function Av(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:at("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function yv(n,e,t){const i=new WeakMap,r=new Rt;function s(a,o,c){const l=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=d!==void 0?d.length:0;let u=i.get(o);if(u===void 0||u.count!==f){let C=function(){w.dispose(),i.delete(o),o.removeEventListener("dispose",C)};u!==void 0&&u.texture.dispose();const p=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let A=0;p===!0&&(A=1),x===!0&&(A=2),S===!0&&(A=3);let T=o.attributes.position.count*A,L=1;T>e.maxTextureSize&&(L=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const M=new Float32Array(T*L*4*f),w=new pu(M,T,L,f);w.type=hn,w.needsUpdate=!0;const _=A*4;for(let P=0;P<f;P++){const R=m[P],O=h[P],$=E[P],Y=T*L*4*P;for(let y=0;y<R.count;y++){const N=y*_;p===!0&&(r.fromBufferAttribute(R,y),M[Y+N+0]=r.x,M[Y+N+1]=r.y,M[Y+N+2]=r.z,M[Y+N+3]=0),x===!0&&(r.fromBufferAttribute(O,y),M[Y+N+4]=r.x,M[Y+N+5]=r.y,M[Y+N+6]=r.z,M[Y+N+7]=0),S===!0&&(r.fromBufferAttribute($,y),M[Y+N+8]=r.x,M[Y+N+9]=r.y,M[Y+N+10]=r.z,M[Y+N+11]=$.itemSize===4?r.w:1)}}u={count:f,texture:w,size:new ut(T,L)},i.set(o,u),o.addEventListener("dispose",C)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let p=0;for(let S=0;S<l.length;S++)p+=l[S];const x=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(n,"morphTargetBaseInfluence",x),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",u.size)}return{update:s}}function Tv(n,e,t,i,r){let s=new WeakMap;function a(l){const d=r.render.frame,f=l.geometry,u=e.get(l,f);if(s.get(u)!==d&&(e.update(u),s.set(u,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==d&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,d))),l.isSkinnedMesh){const p=l.skeleton;s.get(p)!==d&&(p.update(),s.set(p,d))}return u}function o(){s=new WeakMap}function c(l){const d=l.target;d.removeEventListener("dispose",c),i.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const Cv={[Qc]:"LINEAR_TONE_MAPPING",[eu]:"REINHARD_TONE_MAPPING",[tu]:"CINEON_TONE_MAPPING",[nu]:"ACES_FILMIC_TONE_MAPPING",[ru]:"AGX_TONE_MAPPING",[su]:"NEUTRAL_TONE_MAPPING",[iu]:"CUSTOM_TONE_MAPPING"};function wv(n,e,t,i,r){const s=new yn(e,t,{type:n,depthBuffer:i,stencilBuffer:r,depthTexture:i?new Qi(e,t):void 0}),a=new yn(e,t,{type:zn,depthBuffer:!1,stencilBuffer:!1}),o=new Wt;o.setAttribute("position",new bt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new bt([0,2,0,0,2,0],2));const c=new Ex({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Ut(o,c),d=new Tu(-1,1,1,-1,0,1);let f=null,u=null,p=!1,x,S=null,m=[],h=!1;this.setSize=function(E,A){s.setSize(E,A),a.setSize(E,A);for(let T=0;T<m.length;T++){const L=m[T];L.setSize&&L.setSize(E,A)}},this.setEffects=function(E){m=E,h=m.length>0&&m[0].isRenderPass===!0;const A=s.width,T=s.height;for(let L=0;L<m.length;L++){const M=m[L];M.setSize&&M.setSize(A,T)}},this.begin=function(E,A){if(p||E.toneMapping===An&&m.length===0)return!1;if(S=A,A!==null){const T=A.width,L=A.height;(s.width!==T||s.height!==L)&&this.setSize(T,L)}return h===!1&&E.setRenderTarget(s),x=E.toneMapping,E.toneMapping=An,!0},this.hasRenderPass=function(){return h},this.end=function(E,A){E.toneMapping=x,p=!0;let T=s,L=a;for(let M=0;M<m.length;M++){const w=m[M];if(w.enabled!==!1&&(w.render(E,L,T,A),w.needsSwap!==!1)){const _=T;T=L,L=_}}if(f!==E.outputColorSpace||u!==E.toneMapping){f=E.outputColorSpace,u=E.toneMapping,c.defines={},it.getTransfer(f)===ft&&(c.defines.SRGB_TRANSFER="");const M=Cv[u];M&&(c.defines[M]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,E.setRenderTarget(S),E.render(l,d),S=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),a.dispose(),o.dispose(),c.dispose()}}const Nu=new qt,Mo=new Qi(1,1),Fu=new pu,Lu=new j0,Pu=new Eu,ac=[],oc=[],lc=new Float32Array(16),cc=new Float32Array(9),uc=new Float32Array(4);function sr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=ac[r];if(s===void 0&&(s=new Float32Array(r),ac[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function Pt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Dt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Us(n,e){let t=oc[e];t===void 0&&(t=new Int32Array(e),oc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Rv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Nv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2fv(this.addr,e),Dt(t,e)}}function Fv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Pt(t,e))return;n.uniform3fv(this.addr,e),Dt(t,e)}}function Lv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4fv(this.addr,e),Dt(t,e)}}function Pv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Pt(t,i))return;uc.set(i),n.uniformMatrix2fv(this.addr,!1,uc),Dt(t,i)}}function Dv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Pt(t,i))return;cc.set(i),n.uniformMatrix3fv(this.addr,!1,cc),Dt(t,i)}}function Iv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Pt(t,i))return;lc.set(i),n.uniformMatrix4fv(this.addr,!1,lc),Dt(t,i)}}function Uv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Bv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2iv(this.addr,e),Dt(t,e)}}function Ov(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;n.uniform3iv(this.addr,e),Dt(t,e)}}function kv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4iv(this.addr,e),Dt(t,e)}}function Vv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function zv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2uiv(this.addr,e),Dt(t,e)}}function Gv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;n.uniform3uiv(this.addr,e),Dt(t,e)}}function Hv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4uiv(this.addr,e),Dt(t,e)}}function Wv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Mo.compareFunction=t.isReversedDepthBuffer()?Xo:$o,s=Mo):s=Nu,t.setTexture2D(e||s,r)}function $v(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Lu,r)}function Xv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Pu,r)}function qv(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Fu,r)}function Yv(n){switch(n){case 5126:return Rv;case 35664:return Nv;case 35665:return Fv;case 35666:return Lv;case 35674:return Pv;case 35675:return Dv;case 35676:return Iv;case 5124:case 35670:return Uv;case 35667:case 35671:return Bv;case 35668:case 35672:return Ov;case 35669:case 35673:return kv;case 5125:return Vv;case 36294:return zv;case 36295:return Gv;case 36296:return Hv;case 35678:case 36198:case 36298:case 36306:case 35682:return Wv;case 35679:case 36299:case 36307:return $v;case 35680:case 36300:case 36308:case 36293:return Xv;case 36289:case 36303:case 36311:case 36292:return qv}}function Kv(n,e){n.uniform1fv(this.addr,e)}function Zv(n,e){const t=sr(e,this.size,2);n.uniform2fv(this.addr,t)}function jv(n,e){const t=sr(e,this.size,3);n.uniform3fv(this.addr,t)}function Jv(n,e){const t=sr(e,this.size,4);n.uniform4fv(this.addr,t)}function Qv(n,e){const t=sr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function eS(n,e){const t=sr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function tS(n,e){const t=sr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function nS(n,e){n.uniform1iv(this.addr,e)}function iS(n,e){n.uniform2iv(this.addr,e)}function rS(n,e){n.uniform3iv(this.addr,e)}function sS(n,e){n.uniform4iv(this.addr,e)}function aS(n,e){n.uniform1uiv(this.addr,e)}function oS(n,e){n.uniform2uiv(this.addr,e)}function lS(n,e){n.uniform3uiv(this.addr,e)}function cS(n,e){n.uniform4uiv(this.addr,e)}function uS(n,e,t){const i=this.cache,r=e.length,s=Us(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));let a;this.type===n.SAMPLER_2D_SHADOW?a=Mo:a=Nu;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function dS(n,e,t){const i=this.cache,r=e.length,s=Us(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Lu,s[a])}function fS(n,e,t){const i=this.cache,r=e.length,s=Us(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Pu,s[a])}function hS(n,e,t){const i=this.cache,r=e.length,s=Us(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Fu,s[a])}function pS(n){switch(n){case 5126:return Kv;case 35664:return Zv;case 35665:return jv;case 35666:return Jv;case 35674:return Qv;case 35675:return eS;case 35676:return tS;case 5124:case 35670:return nS;case 35667:case 35671:return iS;case 35668:case 35672:return rS;case 35669:case 35673:return sS;case 5125:return aS;case 36294:return oS;case 36295:return lS;case 36296:return cS;case 35678:case 36198:case 36298:case 36306:case 35682:return uS;case 35679:case 36299:case 36307:return dS;case 35680:case 36300:case 36308:case 36293:return fS;case 36289:case 36303:case 36311:case 36292:return hS}}class mS{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Yv(t.type)}}class xS{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=pS(t.type)}}class gS{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const Ma=/(\w+)(\])?(\[|\.)?/g;function dc(n,e){n.seq.push(e),n.map[e.id]=e}function _S(n,e,t){const i=n.name,r=i.length;for(Ma.lastIndex=0;;){const s=Ma.exec(i),a=Ma.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){dc(t,l===void 0?new mS(o,n,e):new xS(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new gS(o),dc(t,f)),t=f}}}class hs{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);_S(o,c,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=i[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function fc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const vS=37297;let SS=0;function MS(n,e){const t=n.split(`
...
`)+`
`+h);const A=E+m+a,T=E+h+o,L=fc(r,r.VERTEX_SHADER,A),M=fc(r,r.FRAGMENT_SHADER,T);r.attachShader(S,L),r.attachShader(S,M),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function w(R){if(n.debug.checkShaderErrors){const O=r.getProgramInfoLog(S)||"",$=r.getShaderInfoLog(L)||"",Y=r.getShaderInfoLog(M)||"",y=O.trim(),N=$.trim(),F=Y.trim();let k=!0,H=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(k=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,S,L,M);else{const j=pc(r,L,"vertex"),re=pc(r,M,"fragment");at("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
`)return"hard-break"}return n===" "?"space":n===" "||n===" "||n==="⁠"||n==="\uFEFF"?"glue":n==="​"?"zero-width-break":n==="­"?"soft-hyphen":"text"}const a1=/[\x20\t\n\xA0\xAD\u200B\u202F\u2060\uFEFF]/;function ln(n){return n.length===1?n[0]:n.join("")}function o1(n,e){const t=[];for(let i=n.length-1;i>=0;i--)t.push(n[i]);return t.push(e),ln(t)}function l1(n,e,t,i){if(!a1.test(n))return[{text:n,isWordLike:e,kind:"text",start:t}];const r=[];let s=null,a=[],o=t,c=!1,l=0;for(const d of n){const f=s1(d,i),u=f==="text"&&e;if(s!==null&&f===s&&u===c){a.push(d),l+=d.length;continue}s!==null&&r.push({text:ln(a),isWordLike:c,kind:s,start:o}),s=f,a=[d],o=t+l,c=u,l+=d.length}return s!==null&&r.push({text:ln(a),isWordLike:c,kind:s,start:o}),r}function yo(n){return n==="space"||n==="preserved-space"||n==="zero-width-break"||n==="hard-break"}const c1=/^[A-Za-z][A-Za-z0-9+.-]*:$/;function u1(n,e){const t=n.texts[e];return t.startsWith("www.")?!0:c1.test(t)&&e+1<n.len&&n.kinds[e+1]==="text"&&n.texts[e+1]==="//"}function d1(n){return n.includes("?")&&(n.includes("://")||n.startsWith("www."))}function f1(n){const e=n.texts.slice(),t=n.isWordLike.slice(),i=n.kinds.slice(),r=n.starts.slice();for(let a=0;a<n.len;a++){if(i[a]!=="text"||!u1(n,a))continue;const o=[e[a]];let c=a+1;for(;c<n.len&&!yo(i[c]);){o.push(e[c]),t[a]=!0;const l=e[c].includes("?");if(i[c]="text",e[c]="",c++,l)break}e[a]=ln(o)}let s=0;for(let a=0;a<e.length;a++){const o=e[a];o.length!==0&&(s!==a&&(e[s]=o,t[s]=t[a],i[s]=i[a],r[s]=r[a]),s++)}return e.length=s,t.length=s,i.length=s,r.length=s,{len:s,texts:e,isWordLike:t,kinds:i,starts:r}}function h1(n){const e=[],t=[],i=[],r=[];for(let s=0;s<n.len;s++){const a=n.texts[s];if(e.push(a),t.push(n.isWordLike[s]),i.push(n.kinds[s]),r.push(n.starts[s]),!d1(a))continue;const o=s+1;if(o>=n.len||yo(n.kinds[o]))continue;const c=[],l=n.starts[o];let d=o;for(;d<n.len&&!yo(n.kinds[d]);)c.push(n.texts[d]),d++;c.length>0&&(e.push(ln(c)),t.push(!0),i.push("text"),r.push(l),s=d-1)}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}const p1=new Set([":","-","/","×",",",".","+","–","—"]),Rc=/^[A-Za-z0-9_]+[,:;]*$/,Nc=/[,:;]+$/;function Bu(n){for(const e of n)if(Iu.test(e))return!0;return!1}function Ts(n){if(n.length===0)return!1;for(const e of n)if(!(Iu.test(e)||p1.has(e)))return!1;return!0}function m1(n){const e=[],t=[],i=[],r=[];for(let s=0;s<n.len;s++){const a=n.texts[s],o=n.kinds[s];if(o==="text"&&Ts(a)&&Bu(a)){const c=[a];let l=s+1;for(;l<n.len&&n.kinds[l]==="text"&&Ts(n.texts[l]);)c.push(n.texts[l]),l++;e.push(ln(c)),t.push(!0),i.push("text"),r.push(n.starts[s]),s=l-1;continue}e.push(a),t.push(n.isWordLike[s]),i.push(o),r.push(n.starts[s])}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function x1(n){const e=[],t=[],i=[],r=[];for(let s=0;s<n.len;s++){const a=n.texts[s],o=n.kinds[s],c=n.isWordLike[s];if(o==="text"&&c&&Rc.test(a)){const l=[a];let d=Nc.test(a),f=s+1;for(;d&&f<n.len&&n.kinds[f]==="text"&&n.isWordLike[f]&&Rc.test(n.texts[f]);){const u=n.texts[f];l.push(u),d=Nc.test(u),f++}e.push(ln(l)),t.push(!0),i.push("text"),r.push(n.starts[s]),s=f-1;continue}e.push(a),t.push(c),i.push(o),r.push(n.starts[s])}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function g1(n){const e=[],t=[],i=[],r=[];for(let s=0;s<n.len;s++){const a=n.texts[s];if(n.kinds[s]==="text"&&a.includes("-")){const o=a.split("-");let c=o.length>1;for(let l=0;l<o.length;l++){const d=o[l];if(!c)break;(d.length===0||!Bu(d)||!Ts(d))&&(c=!1)}if(c){let l=0;for(let d=0;d<o.length;d++){const f=o[d],u=d<o.length-1?`${f}-`:f;e.push(u),t.push(!0),i.push("text"),r.push(n.starts[s]+l),l+=u.length}continue}}e.push(a),t.push(n.isWordLike[s]),i.push(n.kinds[s]),r.push(n.starts[s])}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function _1(n){const e=[],t=[],i=[],r=[];let s=0;for(;s<n.len;){const a=[n.texts[s]];let o=n.isWordLike[s],c=n.kinds[s],l=n.starts[s];if(c==="glue"){const d=[a[0]],f=l;for(s++;s<n.len&&n.kinds[s]==="glue";)d.push(n.texts[s]),s++;const u=ln(d);if(s<n.len&&n.kinds[s]==="text")a[0]=u,a.push(n.texts[s]),o=n.isWordLike[s],c="text",l=f,s++;else{e.push(u),t.push(!1),i.push("glue"),r.push(f);continue}}else s++;if(c==="text")for(;s<n.len&&n.kinds[s]==="glue";){const d=[];for(;s<n.len&&n.kinds[s]==="glue";)d.push(n.texts[s]),s++;const f=ln(d);if(s<n.len&&n.kinds[s]==="text"){a.push(f,n.texts[s]),o=o||n.isWordLike[s],s++;continue}a.push(f)}e.push(ln(a)),t.push(o),i.push(c),r.push(l)}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function v1(n){const e=n.texts.slice(),t=n.isWordLike.slice(),i=n.kinds.slice(),r=n.starts.slice();for(let s=0;s<e.length-1;s++){if(i[s]!=="text"||i[s+1]!=="text"||!Hn(e[s])||!Hn(e[s+1]))continue;const a=t1(e[s]);a!==null&&(e[s]=a.head,e[s+1]=a.tail+e[s+1],r[s+1]=r[s]+a.head.length)}return{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function Fc(n,e,t){const i=HM();let r=0;const s=[],a=[],o=[],c=[],l=[],d=[],f=[],u=[],p=[],x=[],S=[],m=[];for(const M of i.segment(n))for(const w of l1(M.segment,M.isWordLike??!1,M.index,t)){let N=function(){d[y]!==null&&(a[y]=[Cc(s,d,f,y)],d[y]=null),a[y].push(w.text),o[y]=o[y]||w.isWordLike,u[y]=u[y]||P,p[y]=p[y]||R,x[y]=$,S[y]=Y,m[y]=wc(p[y],O)};const _=w.kind==="text",C=n1(w.text,w.isWordLike,w.kind),P=Hn(w.text),R=yc(w.text),O=ks(w.text),$=Ao(w.text),Y=i1(w.text),y=r-1;e.carryCJKAfterClosingQuote&&_&&r>0&&c[y]==="text"&&P&&u[y]&&x[y]||_&&r>0&&c[y]==="text"&&QM(w.text)&&u[y]||_&&r>0&&c[y]==="text"&&S[y]?N():_&&r>0&&c[y]==="text"&&w.isWordLike&&R&&m[y]?(N(),o[y]=!0):C!==null&&r>0&&c[y]==="text"&&d[y]===C?f[y]=(f[y]??1)+1:_&&!w.isWordLike&&r>0&&c[y]==="text"&&!u[y]&&(JM(w.text)||w.text==="-"&&o[y])?N():(s[r]=w.text,a[r]=[w.text],o[r]=w.isWordLike,c[r]=w.kind,l[r]=w.start,d[r]=C,f[r]=C===null?0:1,u[r]=P,p[r]=R,x[r]=$,S[r]=Y,m[r]=wc(R,O),r++)}for(let M=0;M<r;M++){if(d[M]!==null){s[M]=Cc(s,d,f,M);continue}s[M]=ln(a[M])}for(let M=1;M<r;M++)c[M]==="text"&&!o[M]&&Jo(s[M])&&c[M-1]==="text"&&!u[M-1]&&(s[M-1]+=s[M],o[M-1]=o[M-1]||o[M],s[M]="");const h=Array.from({length:r},()=>null);let E=-1;for(let M=r-1;M>=0;M--){const w=s[M];if(w.length!==0){if(c[M]==="text"&&!o[M]&&e1(w)&&E>=0&&c[E]==="text"){const _=h[E]??[];_.push(w),h[E]=_,l[E]=l[M],s[M]="";continue}E=M}}for(let M=0;M<r;M++){const w=h[M];w!=null&&(s[M]=o1(w,s[M]))}let A=0;for(let M=0;M<r;M++){const w=s[M];w.length!==0&&(A!==M&&(s[A]=w,o[A]=o[M],c[A]=c[M],l[A]=l[M]),A++)}s.length=A,o.length=A,c.length=A,l.length=A;const T=_1({len:A,texts:s,isWordLike:o,kinds:c,starts:l}),L=v1(x1(g1(m1(h1(f1(T))))));for(let M=0;M<L.len-1;M++){const w=r1(L.texts[M]);w!==null&&(L.kinds[M]!=="space"&&L.kinds[M]!=="preserved-space"||L.kinds[M+1]!=="text"||!yc(L.texts[M+1])||(L.texts[M]=w.space,L.isWordLike[M]=!1,L.kinds[M]=L.kinds[M]==="preserved-space"?"preserved-space":"space",L.texts[M+1]=w.marks+L.texts[M+1],L.starts[M+1]=L.starts[M]+w.space.length))}return L}function S1(n,e){if(n.len===0)return[];if(!e.preserveHardBreaks)return[{startSegmentIndex:0,endSegmentIndex:n.len,consumedEndSegmentIndex:n.len}];const t=[];let i=0;for(let r=0;r<n.len;r++)n.kinds[r]==="hard-break"&&(t.push({startSegmentIndex:i,endSegmentIndex:r,consumedEndSegmentIndex:r+1}),i=r+1);return i<n.len&&t.push({startSegmentIndex:i,endSegmentIndex:n.len,consumedEndSegmentIndex:n.len}),t}function M1(n){if(n.len<=1)return n;const e=[],t=[],i=[],r=[];let s=null,a=!1,o=0,c=!1,l=!1;function d(){s!==null&&(e.push(ln(s)),t.push(a),i.push("text"),r.push(o),s=null)}for(let f=0;f<n.len;f++){const u=n.texts[f],p=n.kinds[f],x=n.isWordLike[f],S=n.starts[f];if(p==="text"){const m=qM(u),h=bo(u);if(s!==null&&c&&l){s.push(u),a=a||x,c=c||m,l=h;continue}d(),s=[u],a=x,o=S,c=m,l=h;continue}d(),e.push(u),t.push(x),i.push(p),r.push(S)}return d(),{len:e.length,texts:e,isWordLike:t,kinds:i,starts:r}}function E1(n,e,t="normal",i="normal"){const r=kM(t),s=r.mode==="pre-wrap"?zM(n):VM(n);if(s.length===0)return{normalized:s,chunks:[],len:0,texts:[],isWordLike:[],kinds:[],starts:[]};const a=i==="keep-all"?M1(Fc(s,e,r)):Fc(s,e,r);return{normalized:s,chunks:S1(a,r),...a}}let Wi=null;const Lc=new Map;let $i=null;const b1=96,A1=new RegExp("\\p{Emoji_Presentation}","u"),y1=/[\p{Emoji_Presentation}\p{Extended_Pictographic}\p{Regional_Indicator}\uFE0F\u20E3]/u;let Aa=null;const Pc=new Map;function Qo(){if(Wi!==null)return Wi;if(typeof OffscreenCanvas<"u")return Wi=new OffscreenCanvas(1,1).getContext("2d"),Wi;if(typeof document<"u")return Wi=document.createElement("canvas").getContext("2d"),Wi;throw new Error("Text measurement requires OffscreenCanvas or a DOM canvas context.")}function T1(n){let e=Lc.get(n);return e||(e=new Map,Lc.set(n,e)),e}function ni(n,e){let t=e.get(n);return t===void 0&&(t={width:Qo().measureText(n).width,containsCJK:Hn(n)},e.set(n,t)),t}function Vs(){if($i!==null)return $i;if(typeof navigator>"u")return $i={lineFitEpsilon:.005,carryCJKAfterClosingQuote:!1,preferPrefixWidthsForBreakableRuns:!1,preferEarlySoftHyphenBreak:!1},$i;const n=navigator.userAgent,t=navigator.vendor==="Apple Computer, Inc."&&n.includes("Safari/")&&!n.includes("Chrome/")&&!n.includes("Chromium/")&&!n.includes("CriOS/")&&!n.includes("FxiOS/")&&!n.includes("EdgiOS/"),i=n.includes("Chrome/")||n.includes("Chromium/")||n.includes("CriOS/")||n.includes("Edg/");return $i={lineFitEpsilon:t?1/64:.005,carryCJKAfterClosingQuote:i,preferPrefixWidthsForBreakableRuns:t,preferEarlySoftHyphenBreak:t},$i}function C1(n){const e=n.match(/(\d+(?:\.\d+)?)\s*px/);return e?parseFloat(e[1]):16}function Ou(){return Aa===null&&(Aa=new Intl.Segmenter(void 0,{granularity:"grapheme"})),Aa}function w1(n){return A1.test(n)||n.includes("️")}function R1(n){return y1.test(n)}function N1(n,e){let t=Pc.get(n);if(t!==void 0)return t;const i=Qo();i.font=n;const r=i.measureText("😀").width;if(t=0,r>e+.5&&typeof document<"u"&&document.body!==null){const s=document.createElement("span");s.style.font=n,s.style.display="inline-block",s.style.visibility="hidden",s.style.position="absolute",s.textContent="😀",document.body.appendChild(s);const a=s.getBoundingClientRect().width;document.body.removeChild(s),r-a>.5&&(t=r-a)}return Pc.set(n,t),t}function F1(n){let e=0;const t=Ou();for(const i of t.segment(n))w1(i.segment)&&e++;return e}function L1(n,e){return e.emojiCount===void 0&&(e.emojiCount=F1(n)),e.emojiCount}function gi(n,e,t){return t===0?e.width:e.width-L1(n,e)*t}function P1(n,e,t,i,r){if(e.breakableFitAdvances!==void 0&&e.breakableFitMode===r)return e.breakableFitAdvances;e.breakableFitMode=r;const s=Ou(),a=[];for(const d of s.segment(n))a.push(d.segment);if(a.length<=1)return e.breakableFitAdvances=null,e.breakableFitAdvances;if(r==="sum-graphemes"){const d=[];for(const f of a){const u=ni(f,t);d.push(gi(f,u,i))}return e.breakableFitAdvances=d,e.breakableFitAdvances}if(r==="pair-context"||a.length>b1){const d=[];let f=null,u=0;for(const p of a){const x=ni(p,t),S=gi(p,x,i);if(f===null)d.push(S);else{const m=f+p,h=ni(m,t);d.push(gi(m,h,i)-u)}f=p,u=S}return e.breakableFitAdvances=d,e.breakableFitAdvances}const o=[];let c="",l=0;for(const d of a){c+=d;const f=ni(c,t),u=gi(c,f,i);o.push(u-l),l=u}return e.breakableFitAdvances=o,e.breakableFitAdvances}function D1(n,e){const t=Qo();t.font=n;const i=T1(n),r=C1(n),s=e?N1(n,r):0;return{cache:i,fontSize:r,emojiCorrection:s}}function I1(n){return n==="space"||n==="zero-width-break"||n==="soft-hyphen"}function ku(n){return n==="space"||n==="preserved-space"||n==="tab"||n==="zero-width-break"||n==="soft-hyphen"}function Vu(n,e,t=n.widths.length){for(;e<t;){const i=n.kinds[e];if(!I1(i))break;e++}return e}function U1(n,e){if(e<=0)return 0;const t=n%e;return Math.abs(t)<=1e-6?e:e-t}function B1(n,e,t){return n.letterSpacing!==0&&e&&n.spacingGraphemeCounts[t]>0?n.letterSpacing:0}function el(n,e){return e===0?0:n+e}function O1(n,e){return n.letterSpacing!==0&&n.spacingGraphemeCounts[e]>0?n.letterSpacing:0}function k1(n,e,t,i,r){const s=e==="tab"?r+O1(n,t):n.lineEndFitAdvances[t];return el(i,s)}function Dc(n,e,t,i){const r=e==="tab"?0:n.lineEndFitAdvances[t];return el(i,r)}function Ic(n,e,t,i,r){const s=e==="tab"?r:n.lineEndPaintAdvances[t];return el(i,s)}function V1(n,e,t){return n.letterSpacing!==0&&e?t+n.letterSpacing:t}function z1(n,e){return n.letterSpacing===0?e:e+n.letterSpacing}function G1(n,e,t,i,r,s){let a=0,o=e;for(;a<n.length;){const c=o+n[a]+s;if((a+1<n.length?c+r:c)>t+i)break;o=c,a++}return{fitCount:a,fittedWidth:o}}function H1(n,e,t){const{widths:i,kinds:r,breakableFitAdvances:s}=n;if(i.length===0)return 0;const o=Vs().lineFitEpsilon,c=e+o;let l=0,d=0,f=!1,u=0,p=0,x=0,S=0,m=-1,h=0;function E(){m=-1,h=0}function A(C=x,P=S,R=d){l++,t==null||t(R,u,p,C,P),d=0,f=!1,E()}function T(C,P){f=!0,u=C,p=0,x=C+1,S=0,d=P}function L(C,P,R){f=!0,u=C,p=P,x=C,S=P+1,d=R}function M(C,P){if(!f){T(C,P);return}d+=P,x=C+1,S=0}function w(C,P){const R=s[C];for(let O=P;O<R.length;O++){const $=R[O];f?d+$>c?(A(),L(C,O,$)):(d+=$,x=C,S=O+1):L(C,O,$)}f&&x===C&&S===R.length&&(x=C+1,S=0)}let _=0;for(;_<i.length&&!(!f&&(_=Vu(n,_),_>=i.length));){const C=i[_],P=r[_],R=ku(P);if(!f){C>c&&s[_]!==null?w(_,0):T(_,C),R&&(m=_+1,h=d-C),_++;continue}if(d+C>c){if(R){M(_,C),A(_+1,0,d-C),_++;continue}if(m>=0){if(x>m||x===m&&S>0){A();continue}A(m,0,h);continue}if(C>c&&s[_]!==null){A(),w(_,0),_++;continue}A();continue}M(_,C),R&&(m=_+1,h=d-C),_++}return f&&A(),l}function W1(n,e,t){if(n.simpleLineWalkFastPath)return H1(n,e,t);const{widths:i,kinds:r,breakableFitAdvances:s,discretionaryHyphenWidth:a,chunks:o}=n;if(i.length===0||o.length===0)return 0;const c=Vs(),l=c.lineFitEpsilon,d=e+l;let f=0,u=0,p=!1,x=0,S=0,m=0,h=0,E=-1,A=0,T=0,L=null;function M(){E=-1,A=0,T=0,L=null}function w(y=m,N=h,F=u){f++,t==null||t(F,x,S,y,N),u=0,p=!1,M()}function _(y,N){p=!0,x=y,S=0,m=y+1,h=0,u=N}function C(y,N,F){p=!0,x=y,S=N,m=y,h=N+1,u=F}function P(y,N){if(!p){_(y,N);return}u+=N,m=y+1,h=0}function R(y,N,F,k,H,j){if(!N)return;const re=Dc(n,y,F,H),xe=Ic(n,y,F,H,k);E=F+1,A=u-j+re,T=u-j+xe,L=y}function O(y,N){const F=s[y];for(let k=N;k<F.length;k++){const H=F[k];if(!p)C(y,k,H);else{const j=V1(n,!0,H),re=u+j;z1(n,re)>d?(w(),C(y,k,H)):(u=re,m=y,h=k+1)}}p&&m===y&&h===F.length&&(m=y+1,h=0)}function $(y){if(L!=="soft-hyphen")return!1;const N=s[y];if(N==null)return!1;const{fitCount:F,fittedWidth:k}=G1(N,u,e,l,a,n.letterSpacing);return F===0?!1:(u=k,m=y,h=F,M(),F===N.length?(m=y+1,h=0,!0):(w(y,F,k+a),O(y,F),!0))}function Y(y){f++,t==null||t(0,y.startSegmentIndex,0,y.consumedEndSegmentIndex,0),M()}for(let y=0;y<o.length;y++){const N=o[y];if(N.startSegmentIndex===N.endSegmentIndex){Y(N);continue}p=!1,u=0,x=N.startSegmentIndex,S=0,m=N.startSegmentIndex,h=0,M();let F=N.startSegmentIndex;for(;F<N.endSegmentIndex&&!(!p&&(F=Vu(n,F,N.endSegmentIndex),F>=N.endSegmentIndex));){const k=r[F],H=ku(k),j=B1(n,p,F),re=k==="tab"?U1(u+j,n.tabStopAdvance):i[F],xe=j+re,Re=k1(n,k,F,j,re);if(k==="soft-hyphen"){p&&(m=F+1,h=0,E=F+1,A=u+a,T=u+a,L=k),F++;continue}if(!p){Re>d&&s[F]!==null?O(F,0):_(F,re),R(k,H,F,re,j,xe),F++;continue}if(u+Re>d){const Ie=u+Dc(n,k,F,j),ee=u+Ic(n,k,F,j,re);if(L==="soft-hyphen"&&c.preferEarlySoftHyphenBreak&&A<=d){w(E,0,T);continue}if(L==="soft-hyphen"&&$(F)){F++;continue}if(H&&Ie<=d){P(F,xe),w(F+1,0,ee),F++;continue}if(E>=0&&A<=d){if(m>E||m===E&&h>0){w();continue}const pe=E;w(pe,0,T),F=pe;continue}if(Re>d&&s[F]!==null){w(),O(F,0),F++;continue}w();continue}P(F,xe),R(k,H,F,re,j,xe),F++}if(p){const k=E===N.consumedEndSegmentIndex?T:u;w(N.consumedEndSegmentIndex,0,k)}}return f}let ya=null,Uc=new WeakMap;function $1(){return ya===null&&(ya=new Intl.Segmenter(void 0,{granularity:"grapheme"})),ya}function Bc(n,e,t){let i=t.get(n);if(i!==void 0)return i;i=[];const r=$1();for(const s of r.segment(e[n]))i.push(s.segment);return t.set(n,i),i}function X1(n,e,t,i){return i>0&&n[i-1]==="soft-hyphen"&&!(e===i&&t>0)}function Oc(n,e,t,i){for(let r=t;r<i;r++)n+=e[r];return n}function q1(n){let e=Uc.get(n);return e!==void 0||(e=new Map,Uc.set(n,e)),e}function Y1(n,e,t,i,r,s){let a="";const o=X1(n.kinds,t,i,r);for(let c=t;c<r;c++)if(!(n.kinds[c]==="soft-hyphen"||n.kinds[c]==="hard-break"))if(c===t&&i>0){const l=Bc(c,n.segments,e);a=Oc(a,l,i,l.length)}else a+=n.segments[c];if(s>0){o&&(a+="-");const c=Bc(r,n.segments,e);a=Oc(a,c,t===r?i:0,s)}else o&&(a+="-");return a}let Ta=null;function zu(){return Ta===null&&(Ta=new Intl.Segmenter(void 0,{granularity:"grapheme"})),Ta}function K1(n){return{widths:[],lineEndFitAdvances:[],lineEndPaintAdvances:[],kinds:[],simpleLineWalkFastPath:!0,segLevels:null,breakableFitAdvances:[],letterSpacing:0,spacingGraphemeCounts:[],discretionaryHyphenWidth:0,tabStopAdvance:0,chunks:[],segments:[]}}function Z1(n,e){const t=[];let i=[],r=0,s=!1,a=!1,o=!1;function c(){i.length!==0&&(t.push({text:i.length===1?i[0]:i.join(""),start:r}),i=[],s=!1,a=!1,o=!1)}function l(f,u,p){i=[f],r=u,s=p,a=Ao(f),o=Os.has(f)}function d(f,u){i.push(f),s=s||u;const p=Ao(f);f.length===1&&bi.has(f)?a=a||p:a=p,o=!1}for(const f of zu().segment(n)){const u=f.segment,p=Hn(u);if(i.length===0){l(u,f.index,p);continue}if(o||Zo.has(u)||bi.has(u)||e.carryCJKAfterClosingQuote&&p&&a){d(u,p);continue}if(!s&&!p){d(u,p);continue}c(),l(u,f.index,p)}return c(),t}function j1(n){if(n.length<=1)return n;const e=[];let t=[n[0].text],i=n[0].start,r=Hn(n[0].text),s=bo(n[0].text);function a(){e.push({text:t.length===1?t[0]:t.join(""),start:i})}for(let o=1;o<n.length;o++){const c=n[o],l=Hn(c.text),d=bo(c.text);if(r&&s){t.push(c.text),r=r||l,s=d;continue}a(),t=[c.text],i=c.start,r=l,s=d}return a(),e}function kc(n,e){if(e==="zero-width-break"||e==="soft-hyphen"||e==="hard-break")return 0;if(e==="tab")return 1;let t=0;const i=zu();for(const r of i.segment(n))t++;return t}function J1(n,e,t){return e>1?n+(e-1)*t:n}function Q1(n,e,t,i,r){const s=Vs(),{cache:a,emojiCorrection:o}=D1(e,R1(n.normalized)),c=gi("-",ni("-",a),o)+(r===0?0:r),d=gi(" ",ni(" ",a),o)*8,f=r!==0;if(n.len===0)return K1();const u=[],p=[],x=[],S=[];let m=n.chunks.length<=1&&!f;const h=[],E=[],A=[],T=t?[]:null,L=Array.from({length:n.len});function M(P,R,O,$,Y,y,N,F){Y!=="text"&&Y!=="space"&&Y!=="zero-width-break"&&(m=!1),u.push(R),p.push(O),x.push($),S.push(Y),h==null||h.push(y),E.push(N),f&&A.push(F),T!==null&&T.push(P)}function w(P,R,O,$,Y){const y=ni(P,a),N=f?kc(P,R):0,F=J1(gi(P,y,o),N,r),k=R==="space"||R==="preserved-space"||R==="zero-width-break"?0:F,H=k===0?0:k+(N>0?r:0),j=R==="space"||R==="zero-width-break"?0:F;if(Y&&$&&P.length>1){let re="sum-graphemes";r!==0?re="segment-prefixes":Ts(P)?re="pair-context":s.preferPrefixWidthsForBreakableRuns&&(re="segment-prefixes");const xe=P1(P,y,a,o,re);M(P,F,H,j,R,O,xe,N);return}M(P,F,H,j,R,O,null,N)}for(let P=0;P<n.len;P++){L[P]=u.length;const R=n.texts[P],O=n.isWordLike[P],$=n.kinds[P],Y=n.starts[P];if($==="soft-hyphen"){M(R,0,c,c,$,Y,null,0);continue}if($==="hard-break"){M(R,0,0,0,$,Y,null,0);continue}if($==="tab"){M(R,0,0,0,$,Y,null,f?kc(R,$):0);continue}const y=ni(R,a);if($==="text"&&y.containsCJK){const N=Z1(R,s),F=i==="keep-all"?j1(N):N;for(let k=0;k<F.length;k++){const H=F[k];w(H.text,"text",Y+H.start,O,i==="keep-all"||!Hn(H.text))}continue}w(R,$,Y,O,!0)}const _=eE(n.chunks,L,u.length),C=h===null?null:UM(n.normalized,h);return T!==null?{widths:u,lineEndFitAdvances:p,lineEndPaintAdvances:x,kinds:S,simpleLineWalkFastPath:m,segLevels:C,breakableFitAdvances:E,letterSpacing:r,spacingGraphemeCounts:A,discretionaryHyphenWidth:c,tabStopAdvance:d,chunks:_,segments:T}:{widths:u,lineEndFitAdvances:p,lineEndPaintAdvances:x,kinds:S,simpleLineWalkFastPath:m,segLevels:C,breakableFitAdvances:E,letterSpacing:r,spacingGraphemeCounts:A,discretionaryHyphenWidth:c,tabStopAdvance:d,chunks:_}}function eE(n,e,t){const i=[];for(let r=0;r<n.length;r++){const s=n[r],a=s.startSegmentIndex<e.length?e[s.startSegmentIndex]:t,o=s.endSegmentIndex<e.length?e[s.endSegmentIndex]:t,c=s.consumedEndSegmentIndex<e.length?e[s.consumedEndSegmentIndex]:t;i.push({startSegmentIndex:a,endSegmentIndex:o,consumedEndSegmentIndex:c})}return i}function tE(n,e,t,i){const r=(i==null?void 0:i.wordBreak)??"normal",s=(i==null?void 0:i.letterSpacing)??0,a=E1(n,Vs(),i==null?void 0:i.whiteSpace,r);return Q1(a,e,t,r,s)}function nE(n,e,t){return tE(n,e,!0,t)}function iE(n,e,t,i,r,s,a){return{text:Y1(n,e,i,r,s,a),width:t,start:{segmentIndex:i,graphemeIndex:r},end:{segmentIndex:s,graphemeIndex:a}}}function rE(n,e,t){const i=[];if(n.widths.length===0)return{lineCount:0,height:0,lines:i};const r=q1(n),s=W1(n,e,(a,o,c,l,d)=>{i.push(iE(n,r,a,o,c,l,d))});return{lineCount:s,height:s*t,lines:i}}function sE(){return typeof document>"u"||typeof HTMLCanvasElement>"u"}const Vc=new Map;function aE(n,e,t){return JSON.stringify({t:n,f:e,o:t??{}})}function oE(n,e,t){if(sE())return null;const i=aE(n,e,t);let r=Vc.get(i);return r||(r={plain:null,segmented:null},Vc.set(i,r)),r.segmented||(r.segmented=nE(n,e,t)),r.segmented}function lE(n,e,t){return n?rE(n,e,t):{height:0,lineCount:0,lines:[]}}const cE={class:"problem-visual","aria-labelledby":"problem-title"},uE={class:"problem-stage"},dE=Ce({__name:"ProblemVisual",setup(n){const e=et(null);let t=0,i=null;const r=["OpenAI-compatible","Anthropic-shaped","delta != event","tool_choice drift","missing usage","error envelope?","model aliases","SSE retry","schema mismatch","canonical contract"];function s(o=0){const c=e.value;if(!c)return;const l=c.getContext("2d");if(!l)return;const d=c.getBoundingClientRect(),f=window.devicePixelRatio||1,u=Math.max(1,Math.floor(d.width)),p=Math.max(1,Math.floor(d.height));(c.width!==u*f||c.height!==p*f)&&(c.width=u*f,c.height=p*f),l.setTransform(f,0,0,f,0,0),l.clearRect(0,0,u,p),l.font="12px ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",l.lineWidth=1;const x=oE("almost compatible != agent compatible","12px ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",{whiteSpace:"pre-wrap"}),m=lE(x,Math.max(220,u*.46),18).lines.length>1?18:0;for(let h=0;h<r.length;h++){const E=h%5,T=(h*137+o*(.012+E*.002))%(u+180)-140,L=28+E*((p-56)/4),M=.14+Math.sin(o*.002+h)*.06;l.fillStyle=`rgba(117, 167, 223, ${M})`,l.fillText(r[h],T,L+m),l.strokeStyle=`rgba(86, 141, 208, ${M*.75})`,l.beginPath(),l.moveTo(T-28,L+6),l.lineTo(T-8,L+6),l.stroke()}l.strokeStyle="rgba(86, 141, 208, 0.12)";for(let h=18;h<p;h+=26)l.beginPath(),l.moveTo(0,h),l.lineTo(u,h),l.stroke()}function a(o=0){s(o),t=window.requestAnimationFrame(a)}return wn(()=>{e.value&&(i=new ResizeObserver(()=>s()),i.observe(e.value)),s(),window.matchMedia("(prefers-reduced-motion: reduce)").matches||(t=window.requestAnimationFrame(a))}),br(()=>{t&&window.cancelAnimationFrame(t),i&&i.disconnect()}),(o,c)=>(B(),Z("section",cE,[J("div",uE,[J("canvas",{ref_key:"canvasEl",ref:e,class:"problem-canvas","aria-hidden":"true"},null,512),c[0]||(c[0]=J("div",{class:"problem-copy"},[J("p",{class:"relay-section-label"},"The Problem"),J("h2",{id:"problem-title",class:"problem-title"},[J("span",null,"Almost compatible"),J("strong",null,"is where agents break.")]),J("p",{class:"problem-lede"}," Local model servers speak familiar protocols until the details matter: stream events, tool calls, fields, errors, and capability metadata. Relay makes the boundary actually compatible. ")],-1))]),c[1]||(c[1]=ps('<div class="problem-ticker" aria-hidden="true" data-v-380f7bcf><span data-v-380f7bcf>headers drift</span><span data-v-380f7bcf>tool calls fork</span><span data-v-380f7bcf>SSE chunks wobble</span><span data-v-380f7bcf>model IDs lie</span><span data-v-380f7bcf>errors change shape</span><span data-v-380f7bcf>agents need one contract</span></div><div class="relay-pain-grid" data-v-380f7bcf><div class="relay-pain-card" data-v-380f7bcf><p data-v-380f7bcf>OpenAI-compatible endpoints differ subtly across local servers - header conventions, field presence, and error shapes don&#39;t match what SDKs expect.</p></div><div class="relay-pain-card" data-v-380f7bcf><p data-v-380f7bcf>Anthropic clients expect different message shapes, streaming event orders, and tool-call structures than what upstream servers return.</p></div><div class="relay-pain-card" data-v-380f7bcf><p data-v-380f7bcf>Tool calls, model IDs, SSE chunk framing, and capability metadata often cause agent loops to break or silently degrade.</p></div><div class="relay-pain-card relay-pain-card-accent" data-v-380f7bcf><p data-v-380f7bcf>Relay normalizes the boundary instead of forcing every client, SDK, and agent to special-case each local inference server.</p></div></div>',2))]))}}),fE=De(dE,[["__scopeId","data-v-380f7bcf"]]),hE={class:"relay-terminal",ref:"terminalEl"},pE={class:"relay-terminal-bar"},mE=["aria-label","title"],xE={key:0},gE={key:1},_E=Ce({__name:"TerminalBlock",setup(n){const e=et(!1);let t=null;function i(){const s=document.querySelector(".relay-terminal pre code");if(!s)return;const a=s.textContent||"";navigator.clipboard.writeText(a).then(()=>{r()}).catch(()=>{const o=document.createElement("textarea");o.value=a,o.style.position="fixed",o.style.opacity="0",document.body.appendChild(o),o.select();try{document.execCommand("copy")}catch{}document.body.removeChild(o),r()})}function r(){e.value=!0,t&&clearTimeout(t),t=setTimeout(()=>{e.value=!1},2e3)}return(s,a)=>(B(),Z("div",hE,[J("div",pE,[a[0]||(a[0]=J("span",{class:"relay-terminal-dot"},null,-1)),a[1]||(a[1]=J("span",{class:"relay-terminal-dot"},null,-1)),a[2]||(a[2]=J("span",{class:"relay-terminal-dot"},null,-1)),a[3]||(a[3]=J("span",{class:"relay-terminal-label"},"terminal",-1)),J("button",{class:lt(["relay-terminal-copy",{"relay-terminal-copy--copied":e.value}]),"aria-label":e.value?"Copied":"Copy to clipboard",title:e.value?"Copied":"Copy to clipboard",onClick:i},[e.value?(B(),Z("span",xE,"✓")):(B(),Z("span",gE,"⧙"))],10,mE)]),J("pre",null,[J("code",null,[te(s.$slots,"default")])])],512))}}),SE={extends:ml,Layout(){return ar(ml.Layout,null,{"nav-bar-title-before":()=>ar("div",{class:"relay-nav-logo"},[ar(Xm,{size:24}),ar("span",{class:"relay-nav-text"},"Relay")]),"home-hero-image":()=>ar(wM,{width:800,height:420})})},enhanceApp({app:n}){n.component("CompatibilityVisual",LM),n.component("ProblemVisual",fE),n.component("TerminalBlock",_E)}};export{SE as R,Tp as c,je as u};
